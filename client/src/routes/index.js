...
const Companies = React.lazy(() => import('../pages/Admin/Companies/Companies'));
...
const Zone = React.lazy(() => import('../pages/Setting/Zone/index'));
const State = React.lazy(() => import('../pages/Setting/State/index'));
const City = React.lazy(() => import('../pages/Setting/City/index'));
const Designation = React.lazy(() => import('../pages/Setting/Designation/index'));
const Target = React.lazy(() => import('../pages/Setting/Target/index'));
...
const AnnualSaleGraph = React.lazy(()=>import('../pages/dashboard/Ecommerce/Annual/Annual-Sale-graph'));
const ProducWiseReport = React.lazy(()=>import('../pages/dashboard/Ecommerce/ProductDetailReport/ProductDetailReport'));
const SingleProductListPage = React.lazy(() => import('../pages/dashboard/Ecommerce/ProductDetailReport/SingleProductListPage'))
const SaleExecutiveReport = React.lazy(()=>import('../pages/dashboard/Ecommerce/SaleExecutiveReport/SaleExecutiveReport'));
const Vender = React.lazy(()=>import('../pages/dashboard/Ecommerce/VenderReport/VenderReport'));
const SingleVendorDetailPage = React.lazy(()=>import('../pages/dashboard/Ecommerce/VenderReport/SingleVendorDetailPage'));
    ...
    return useRoutes([
        { path: '/', element: <Root /> },
        {
            ...
            children: [
                ...
                { path: 'admin', element: <LoadComponent component={Login2} /> },
                { path: 'register2', element: <LoadComponent component={Register2} /> },
                { path: 'confirm2', element: <LoadComponent component={Confirm2} /> },
                { path: 'forget-password2', element: <LoadComponent component={ForgetPassword2} /> },
                { path: 'lock-screen2', element: <LoadComponent component={LockScreen2} /> },
                ...
                // { path: 'admin', element: <LoadComponent component={Admin} /> },
                {
                    path: 'error-404',
        ...
        },
        {
            ...
            //  Admin 
            {
                ...
                {
                    path : 'upload',
                    element:<LoadComponent component={UploadDashBoardPage}/>
                },
                {
                ...
                {
                    path : 'staffmanagment',
                    element:<LoadComponent component={UploadStaffManagmentPage}/>
                },
                {
                    path : 'staffmanagment/employee/:id',
                    element:<LoadComponent component={EmployeeInfoPage}/>
                },
                ...
                // },
                {
                    ...
                    children: [
                        {
                            path: 'zone',
                            element: <LoadComponent component={Zone} />,
                        },
                        {
                            path: 'state',
                        ...
                        {
                            path: 'city',
                            element: <LoadComponent component={City} />,
                        },
                        {
                            path: 'designation',
                        ...
                        {
                            path: 'target',
                            element: <LoadComponent component={Target} />,
                        },
                    ],
                },
                {
                    path:'annual-sale-graph',
                    element: <LoadComponent component = {AnnualSaleGraph} />
                },
                {
                    path:'product-wise-report',
                    element: <LoadComponent component = {ProducWiseReport} />
                },
                {
                    path:'product-wise-report/:id',
                    element: <LoadComponent component = {SingleProductListPage} />
                },
                {
                    path:'sale-executive-report',
                    element: <LoadComponent component = {SaleExecutiveReport} />
                },
                {
                    path:'vendorList',
                    element: <LoadComponent component = {Vender} />
                },
                {
                    path:'Vendor-report/:id',
                    element: <LoadComponent component = {SingleVendorDetailPage} />
                },
                {
                    path: 'apps',
                    children: [
